...
def check_img(img):
    ...
    #если количество людей  больше 1
    if len(personwiseKeypoints)!=1:
        return False
    #если одна из точек не прошла пороговое значение [шея, правая нога, левая нога]
    #если нужно только спереди
    if -1 in personwiseKeypoints[0][[1,10,13]]:
        return False
    return True
